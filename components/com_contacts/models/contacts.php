...
class ContactsModelContacts extends JModelList {
	...
	protected function getListQuery() {
		...
		$query = 'select c.id from #__contacts as c where 1 = 1';
...
//			$item->published = JText::_('COM_CONTACTS_CONTACTS_PUBLISHED_OPTION_' . strtoupper($item->published));
//		}
		return $items;
	}
	...
	protected function loadFormData() {
		...
		if ($error_dateformat) {
			$app->enqueueMessage(JText::_("COM_CONTACTS_SEARCH_FILTER_DATE_FORMAT"), "warning");
